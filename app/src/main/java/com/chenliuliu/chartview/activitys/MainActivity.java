...
//        applyKitKatTranslucency();
    ...
    private void setViewTwo() {
        ...
        chartView.setGridLineColor(R.color.darkblue);
        List<ChartView.ChartData> chartDatas = new ArrayList<>();
        chartDatas.add(new ChartView.ChartData(0.2f, "a", "01/01"));
        chartDatas.add(new ChartView.ChartData(0.4f, "b", "01/02"));
        chartDatas.add(new ChartView.ChartData(0.6f, "c", "01/03"));
